						...
						<div class="col-xs-12">
							...
							<div class="col-12 form-container">
								<form class="row" method="POST" enctype="multipart/form-data" id="serviceForm">
									<input type="hidden" name="type" id="type" value="registrar">
									<div class="col-12">
										<label>Nombre</label>
									...
									<div class="col-12">
										...
										<textarea class="form-control" lbl="Descripción del servicio" id="description" rows="5" name="description"></textarea>
									</div>
									<div class="col-12">
										<label>Imagen</label>
